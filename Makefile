...
$(KERNEL_C_OBJ): $(KERNEL_C_SRC)
	mkdir -p build
	$(CC32) $(C32_CFLAGS) -c -o $(KERNEL_C_OBJ) $(KERNEL_C_SRC)

$(KERNEL_ASM_OBJ): $(KERNEL_SRC)
	mkdir -p build
	nasm -f elf32 -o $(KERNEL_ASM_OBJ) $(KERNEL_SRC)

$(KERNEL_ELF): $(KERNEL_ASM_OBJ) $(KERNEL_C_OBJ) $(KERNEL_LD_SCRIPT)
	mkdir -p build
	$(LD32) $(LD32_FLAGS) -o $(KERNEL_ELF) $(KERNEL_ASM_OBJ) $(KERNEL_C_OBJ)
...
$(KERNEL_PM_A20FAIL_ELF): $(KERNEL_PM_A20FAIL_ASM_OBJ) $(KERNEL_C_OBJ) $(KERNEL_LD_SCRIPT)
	mkdir -p build
	$(LD32) $(LD32_FLAGS) -o $(KERNEL_PM_A20FAIL_ELF) $(KERNEL_PM_A20FAIL_ASM_OBJ) $(KERNEL_C_OBJ)
...
$(KERNEL_PM_BADSEL_ELF): $(KERNEL_PM_BADSEL_ASM_OBJ) $(KERNEL_C_OBJ) $(KERNEL_LD_SCRIPT)
	mkdir -p build
	$(LD32) $(LD32_FLAGS) -o $(KERNEL_PM_BADSEL_ELF) $(KERNEL_PM_BADSEL_ASM_OBJ) $(KERNEL_C_OBJ)
...
$(KERNEL_IH_DIV0_ELF): $(KERNEL_IH_DIV0_ASM_OBJ) $(KERNEL_C_OBJ) $(KERNEL_LD_SCRIPT)
	mkdir -p build
	$(LD32) $(LD32_FLAGS) -o $(KERNEL_IH_DIV0_ELF) $(KERNEL_IH_DIV0_ASM_OBJ) $(KERNEL_C_OBJ)
...
$(KERNEL_IH_UD2_ELF): $(KERNEL_IH_UD2_ASM_OBJ) $(KERNEL_C_OBJ) $(KERNEL_LD_SCRIPT)
	mkdir -p build
	$(LD32) $(LD32_FLAGS) -o $(KERNEL_IH_UD2_ELF) $(KERNEL_IH_UD2_ASM_OBJ) $(KERNEL_C_OBJ)
...
$(KERNEL_IH_MULTI_ELF): $(KERNEL_IH_MULTI_ASM_OBJ) $(KERNEL_C_OBJ) $(KERNEL_LD_SCRIPT)
	mkdir -p build
	$(LD32) $(LD32_FLAGS) -o $(KERNEL_IH_MULTI_ELF) $(KERNEL_IH_MULTI_ASM_OBJ) $(KERNEL_C_OBJ)
